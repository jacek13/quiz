...
#ifdef __wasm__
void JsonHandler::loadJsonFromFile(const QString _name, QByteArray & _dataFromFile)
{
    ...
    document = QJsonDocument::fromJson(_dataFromFile);
...
#else
    networkManager = new QNetworkAccessManager(this); // TODO Możliwy wyciek pamięci
    QObject::connect(networkManager, &QNetworkAccessManager::finished, this, &JsonHandler::onResultFromPage);
    networkManager->get(QNetworkRequest(QUrl(_url)));
#endif
}
